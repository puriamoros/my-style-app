...
('root', '[{"db":"my_style_app","table":"appointments"},{"db":"my_style_app","table":"users"},{"db":"my_style_app","table":"establishments"},{"db":"my_style_app","table":"service_types"},{"db":"my_style_app","table":"services_type"},{"db":"my_style_app","table":"favourites"},{"db":"my_style_app","table":"services"},{"db":"my_style_app","table":"staff"},{"db":"my_style_app","table":"provinces"},{"db":"my_style_app","table":"services_history"}]');
...
('root', '2016-05-29 11:17:31', '{"lang":"es","collation_connection":"utf8mb4_unicode_ci"}');
